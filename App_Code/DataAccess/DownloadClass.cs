...
namespace NetWise.DataAccess
{
    ...
    public partial class DownloadClass
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "DownloadClass");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from DownloadClass");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(NetWise.Entity.DownloadClass model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into DownloadClass(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(NetWise.Entity.DownloadClass model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update DownloadClass set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from DownloadClass ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
        ...
        /// 得到一个对象实体
        /// </summary>
        public NetWise.Entity.DownloadClass GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,CN_Name,EN_Name,ParentId,Sort,C_Pic,B_Pic,CN_Url,EN_Url,Depth,IndexShow from DownloadClass ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
        ...
        /// 得到一个对象实体
        /// </summary>
        public NetWise.Entity.DownloadClass DataRowToModel(DataRow row)
        {
            Entity.DownloadClass model = new NetWise.Entity.DownloadClass();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM DownloadClass ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from DownloadClass T ");
        ...
        /// </summary>
        /// <returns></returns>
        public List<NetWise.Entity.DownloadClass> GetList()
        {
            List<NetWise.Entity.DownloadClass> list = new List<NetWise.Entity.DownloadClass>();

            StringBuilder builder = new StringBuilder();
            builder.Append("select ID,CN_Name,EN_Name,ParentId,Sort,C_Pic,B_Pic,CN_Url,EN_Url,Depth,IndexShow ");
            builder.Append(" from DownloadClass ");
        ...
        public DataSet GetListForNum()
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,CN_Name,EN_Name,ParentId,Sort,C_Pic,B_Pic,CN_Url,EN_Url,Depth,IndexShow,");
            strSql.Append("Num=(select count(*) from Download where ClassId=pc.ID )");
            strSql.Append(" from DownloadClass as pc ");
            return DbHelperSQL.Query(strSql.ToString());
        }
        /// <summary>
        /// 获得深度
        ...
        {
            string sql = "select Depth from DownloadClass where ID=" + ID;
        ...
        {
            string sql = @"SELECT count(*) FROM Download a,f_DownloadNum(@ID) b WHERE a.ClassId = b.ID ";
        ...
        {
            string sql = "update DownloadClass set IndexShow=1 where ID='" + ID + "'";
        ...
        public DataSet GetDownloadClassSort(string CN_Url)
        {
            string sql = @"select a.ID,a.parentid,(REPLICATE('　',b.re_level) +a.CN_Name) as CN_Name,EN_Name,b.re_level,b.re_sort ,b.re_path,a.IndexShow,a.Sort 
                                  from DownloadClass a,f_DownloadClass(0) b where a.ID=b.re_id and CN_Url='" + CN_Url + "' order by re_sort";
        ...
        /// <returns></returns>
        public DataSet GetDownloadClassSort(int classId)
        {
            string sql = @"select a.ID,a.ParentId,a.CN_Name,a.EN_Name,b.re_level,b.re_sort ,b.re_path,a.IndexShow,a.Sort 
                                  from DownloadClass a,f_DownloadClass('" + classId + "') b where a.ID=b.re_id order by re_sort";
            return DbHelperSQL.Query(sql);
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT c.*, c.EN_Name +' > '+ b.EN_Name +' > '+ a.EN_Name PclassName FROM dbo.DownloadClass a");
            strSql.Append(" JOIN dbo.DownloadClass b ON a.ParentId = b.ID");
            strSql.Append(" JOIN dbo.DownloadClass c ON b.ParentId = c.ID");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT b.*, b.EN_Name +' > '+ a.EN_Name PclassName FROM dbo.DownloadClass a");
            strSql.Append(" JOIN dbo.DownloadClass b ON a.ParentId = b.ID");
            strSql.AppendFormat(" WHERE a.id = {0}", classId);
            return DbHelperSQL.Query(strSql.ToString());
        }
