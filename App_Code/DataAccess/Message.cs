...
namespace NetWise.DataAccess
{
    ...
    public partial class Message
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(NetWise.Entity.Message model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Message(");
            strSql.Append("MTitle,MContent,MName,MSex,MCompany,MTel,MFax,MEmail,IsRead,CreateTime,Remark,P_ID)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(NetWise.Entity.Message model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NetWise.Entity.Message GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,MTitle,MContent,MName,MSex,MCompany,MTel,MFax,MEmail,IsRead,CreateTime,Remark,P_ID from Message ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
            ...
            NetWise.Entity.Message model = new NetWise.Entity.Message();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NetWise.Entity.Message DataRowToModel(DataRow row)
        {
            NetWise.Entity.Message model = new NetWise.Entity.Message();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,MTitle,MContent,MName,MSex,MCompany,MTel,MFax,MEmail,IsRead,CreateTime,Remark,P_ID ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,MTitle,MContent,MName,MSex,MCompany,MTel,MFax,MEmail,IsRead,CreateTime,Remark ");
            strSql.Append(" FROM Message ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            string sql = "select count(*) from message where IsRead=0";
