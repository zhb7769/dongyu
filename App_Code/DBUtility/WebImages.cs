...
namespace NetWise.DBUtility
{
    ...
    public class WebImages
    {
        ...
        public static bool GetThumbNail(Stream stream, string savePath, int width, int height, ThumbNailScale scale)
        {
            ...
            {
                //LogControl.LogWrite("从文件流生成缩略图", ex.Message);
                return false;
            }
            finally
            {
        ...
        {
            //缩略图
            System.Drawing.Image img = Image.FromFile(originalImagePath);
        ...
        public System.Drawing.Imaging.ImageFormat GetImageType(object strContentType)
        {
