...
public partial class EnEquipment : System.Web.UI.Page
{
    ...
    private void BindProcess()
    {
        ...
        if (classModel != null)
        {
            ltProcessTitle.Text = classModel.EN_Name;
        }
        ...
        if (model != null)
        {
            ltProcessContent.Text = model.EN_Content;
        }
    }
    ...
    private void BindEquipment()
    {
        ...
        if (classModel != null)
        {
            ltEquipTitle.Text = classModel.EN_Name;
        }
