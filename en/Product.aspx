<%@ Page Title="" Language="C#" MasterPageFile="~/en/MasterPage.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="EnProduct" %>
    ...
    <div class="det_pb">
        <div class="all_ban top_pro">
            <div class="main_bgc">
                ...
                <div class="all_bantit"><a href="Index.aspx">Home</a><i>></i><span>Products</span></div>
            </div>
        </div>
        <div class="det_nav">
        ...
        <div class="det_con">
            <div class="main_bgc">
                <div class="det_cpa">
                    <div class="det_tit">Product Introduction</div>
                            ...
                            <div class="pro_ibg2">
                                <a id="linkSpec" runat="server" class="pro_ia f_flrb">
                                    <div class="flex_1 f_fl">
                                        <i class="pro_i1"></i>
                                        <div class="text flex_1">Specification</div>
                                    </div>
                                    <i class="pro_ir"></i>
                                </a>
                                <a id="linkApp" runat="server" class="pro_ia f_flrb">
                                    <div class="flex_1 f_fl">
                                        <i class="pro_i2"></i>
                                        <div class="text flex_1">Application</div>
                                    </div>
                                    <i class="pro_ir"></i>
                                </a>
                            </div>
                                ...
                                <asp:Repeater ID="rptImages" runat="server">
                                    <ItemTemplate>
                                        <div class="swiper-slide">
                                            <div class="img_auto">
                                                <img src='/uploadfiles/product/<%# Eval("pro_img") %>' alt='<%# Eval("EN_Name") %>' />
                                            </div>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
