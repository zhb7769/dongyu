<%@ Page Title="" Language="C#" MasterPageFile="~/en/MasterPage.master" AutoEventWireup="true" CodeFile="NewsList.aspx.cs" Inherits="EnNewsList" %>
    ...
    <div class="det_pb">
        <div class="all_ban top_news">
            <div class="main_bgc">
                ...
                <div class="all_bantit"><a href="Index.aspx">Home</a><i>></i><span><asp:Literal ID="ltNavTitle" runat="server"></asp:Literal></span></div>
            </div>
        </div>
        <div class="det_con">
            <div class="main_bgc">
