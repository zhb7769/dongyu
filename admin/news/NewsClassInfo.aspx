<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsClassInfo.aspx.cs" Inherits="admin_news_NewsClassInfo" %>
    ...
    <div id="content">
        ...
        <div class="Main">
            ...
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li><a href="NewsClass.aspx">新闻分类</a></li>
                    ...
                    <div class="basic">
                        ...
                        <div class="fieldline">
                            <div class="c1">
                                是否推荐</div>
                            <div class="c3">
                                <asp:CheckBox ID="ckbIsShow" runat="server" CssClass="i-a-tj" /><span class="c2 m-r">推荐</span><div
                                    class="clear">
                                </div>
                            </div>
                            <div class="clear">
