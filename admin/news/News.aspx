...
<head runat="server">
    ...
    <style type="text/css">
        #content .Main .cMain-w .ul-list .title {
            width: 340px;
        }
        #content .Main .cMain-w .ul-list .cz{
            width: 120px;
            float: left;
        }
    </style>
        ...
        <div class="Main">
            ...
            <div class="ss-bor">
                <ul>
                    ...
                    <li>
                        <asp:DropDownList ID="ddlNewsClass" runat="server" CssClass="S-xl">
                    ...
                    <li class="add"><a href="NewsInfo.aspx">添加新闻</a></li>
                    <div class="clear">
                    </div>
                </ul>
            </div>
            ...
            <div class="cMain-w">
                <div class="cMain-title">
                    <ul class="ul-list">
                        ...
                        <li class="order"><span class="underline">置顶</span></li>
                        <li class="cz">操作</li>
                        <div class="clear">
                        </div>
                    </ul>
                ...
                <asp:Repeater ID="rptNews" runat="server" onitemcommand="rptNews_ItemCommand" 
                  ...
                  <ItemTemplate>
                    ...
                    <li class="title"><a href='NewsInfo.aspx=?C_id=<%#Eval("ID") %>'>  <%#Eval("CN_Title")%></a></li>
                    <li class="date-time">
                      <asp:Label ID="lblNewsClass" runat="server" Text='<%#Eval("NewsClassId") %>'></asp:Label></li>
                    ...
                    <li class="order">
                        ...
                        <asp:LinkButton ID="lkbtnSort" runat="server" CommandName="Sort" CommandArgument='<%#Eval("ID") %>'>更</asp:LinkButton>
                        </li>
                    <li class="order">
                        <asp:Image ID="imgIsTop" runat="server" ToolTip='<%#Eval("IsTop") %>' /></li>
                    <li class="cz">
                      <a href='NewsInfo.aspx?C_id=<%#Eval("ID") %>'>编辑</a>
                      <asp:LinkButton ID="lkbtnDel" CommandName="Del" CommandArgument='<%#Eval("ID") %>' runat="server"
                       OnClientClick="return confirm('您确定要删除吗？')">删除</asp:LinkButton>
                        <a href='NewsMsg.aspx?id=<%#Eval("ID") %>'>查看留言</a>
                    </li>
                    <div class="clear">
                    </div>
                </ul>
