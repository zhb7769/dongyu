<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsMsg.aspx.cs" Inherits="admin_news_NewsMsg" %>
...
<head runat="server">
    ...
    <style type="text/css">
        #content .Main .cMain-w .ul-list .Message-Name {
            width: 130px;
        }
        #content .Main .cMain-w .ul-list .email{
            width: 140px;
            float: left;
            text-align: center;
        }
                        ...
                        <asp:Repeater ID="rptMsg" runat="server" onitemcommand="rptMsg_ItemCommand">
                            <ItemTemplate>
                                <ul class="ul-list l">
                                    ...
                                    <li class="Message-con"><%#Eval("MContent")%></li>
                                    <li class="email"><%#Eval("MEmail")%></li>
                                    <li class="Time">
