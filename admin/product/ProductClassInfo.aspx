<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClassInfo.aspx.cs"
    Inherits="admin_product_ProductClassInfo" ValidateRequest="false" %>
            ...
            <div class="add-main">
                ...
                <asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
                    <div class="basic">
                        ...
                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品介绍(中文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckCN_Intro" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>

                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品介绍(英文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckEN_Intro" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>

                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品规格(中文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckCN_Spec" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>

                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品规格(英文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckEN_Spec" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>

                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品应用(中文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckCN_Application" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>

                        <div class="fieldline" style="margin-top:15px;">
                            <div class="c1" style="width:auto; font-weight:bold;">产品应用(英文)</div>
                            <div class="clear"></div>
                        </div>
                        <div class="fieldline">
                            <FCKeditorV2:FCKeditor ID="fckEN_Application" runat="server" Width="700" Height="250" ToolbarSet="Basic"></FCKeditorV2:FCKeditor>
                        </div>
