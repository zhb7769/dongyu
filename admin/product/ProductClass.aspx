<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClass.aspx.cs" Inherits="admin_product_ProductClass" %>
    ...
    <div id="content">
        ...
        <div class="Main">
            ...
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li class="hover1">产品分类</li>
                        <li><a href="ProductClassInfo.aspx">添加分类</a></li>
                        <div class="clear">
                        </div>
                    </ul>
                </div>
                <div class="cMain-w nb">
                    <div class="cMain-title b-t">
                        <ul class="ul-list">
                            ...
                            <li class="Class-num">产品数</li>
                            <li class="order">推荐</li>
                            <li class="Time">排序</li>
                            <li class="cz">操作</li>
                            <div class="clear">
                            </div>
                    ...
                    <div class="cMain-con spro">
                        ...
                        <asp:Repeater ID="rpt_list" runat="server" OnItemCommand="rpt_list_ItemCommand" OnItemDataBound="rpt_list_ItemDataBound">
                            <ItemTemplate>
                                <ul class="ul-list l">
                                    ...
                                    <li class="Class-Name">
                                        <%--<div style='width: 100%; padding-left: <%# Convert.ToInt32(Eval("Depth"))*10%>px;'>--%>
                                            <%# Eval("CN_Name")%> 
                                       <%-- </div>--%>
                                    </li>
                                    <li class="Class-num">
                                    ...
                                    <li class="order">
                                        <asp:Image ID="imgIndexShow" runat="server" ToolTip='<%#Eval("IndexShow") %>' /></li>
                                    <li class="Time">
                                        <%# Eval("Sort")%>
                                    </li>
                                    <li class="cz"><a href='ProductClassInfo.aspx?C_id=<%#Eval("ID") %>'>编辑</a>
                       ...
                       <%--  <ul class="ul-list l">
                            ...
                            <li class="Class-Name">分类名称<br />
                                ENGLISH class</li>
                            <li class="Class-num"><a href="manage_product.html">56</a></li>
                            <li class="order">
                                <img src="images/ico/ok.gif" /></li>
                            <li class="Time">3</li>
                            <li class="cz"><a href="add_productclass.html">编辑</a> <a href="">删除</a></li>
                            <div class="clear">
                            </div>
                        </ul>
                       <ul class="ul-list  l">
                        ...
                        <div>
                            <ul class="ul-list l">
                                <li class="sel">
                                    <input name="" type="checkbox" value="" class="check" /></li>
                                <li class="Class-Name">分类名称</li>
                                <li class="Class-num"><a href="manage_product.html">56</a></li><li class="order">
                                    <img src="images/ico/ok.gif" /></li>
                                <li class="Time">3</li>
                                <li class="cz"><a href="add_productclass.html">编辑</a> <a href="">删除</a></li>
                                <div class="clear">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <ul class="ul-list l">
                                        <li class="sel">
                                            <input name="" type="checkbox" value="" class="check" /></li>
                                        <li class="Class-Name cl04">分类名称</li>
                                        <li class="Class-num"><a href="manage_product.html">56</a></li><li class="order">
                                            <img src="images/ico/ok.gif" /></li>
                                        <li class="Time">3</li>
                                        <li class="cz"><a href="add_productclass.html">编辑</a> <a href="">删除</a></li>
           ...
           <%-- <div class="sale0412">
                <input type="button" class="ss-btn " value="保 存" /></div>--%>
            <!--操作+翻页 开始-->
            <div class="bot">
                <div class="page">
                ...
                &nbsp;<asp:Button ID="btnDo" runat="server" CssClass="ss-btn" Text="批量操作" 
                    onclick="btnDo_Click" />
                <%--<input type="button" class="ss-btn" value="查 询" />--%>
              </div>
            <!--操作+翻页 结束-->
        </div>
        <div class="clear">
