<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AfterService.aspx.cs" Inherits="admin_AfterService_AfterService" %>
...
<body>
    ...
    <div id="content">
        ...
        <div class="Main">
            <div class="Showpath">
                网站管理平台 > <span class="guide-txt">售后服务管理</span></div>
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li class="hover1">售后服务列表</li>
                        <div class="clear">
                        </div>
                    </ul>
                </div>
                            ...
                            <ItemTemplate>
                                <ul class="ul-list l">
                                    ...
                                    <li class="Message-con">
                                        <%#Eval("pName")%></li>
                                    <li class="Time">
                                        <%#Eval("puchaseDate", "{0:yyyy-MM-dd}")%>
                                    </li>
                                    <li class="cz"><a href='AfterServiceInfo.aspx?m_Id=<%#Eval("ID")%>'>查看</a>
