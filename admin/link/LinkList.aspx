<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkList.aspx.cs" Inherits="admin_link_LinkList" %>
...
<div id="content">
    ...
    <!--leftbar end-->
    <div class="Main">
    	<div class="Showpath">网站管理平台  > <span class="guide-txt">友情链接</span></div>
        <!--欢迎及上次登录 开始-->

         <div class="add-main">
          <div class="guide">
            	<ul class="ul-nav02">
                	<li class="hover1">链接列表</li>
                    <li  ><a href="LinkInfo.aspx">添加链接</a></li>
                    <div class="clear"></div>                                  
                </ul>
            </div>            
