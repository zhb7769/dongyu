<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineInfo.aspx.cs" Inherits="admin_link_OnlineInfo" %>
...
<body>
    ...
    <div id="content">
        ...
        <div class="Main">
            <div class="Showpath">
                网站管理平台 > <span class="guide-txt">在线查询</span></div>
            <!--欢迎及上次登录 开始-->
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li><a href="Online.aspx">货物追踪</a></li>
                        <li class="hover">添加货物追踪</li>
                        <div class="clear">
                        </div>
                    </ul>
                </div>
