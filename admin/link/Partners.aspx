<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Partners.aspx.cs" Inherits="admin_link_Partners" %>
...
<div id="content">
    ...
    <!--leftbar end-->
    <div class="Main">
    	<div class="Showpath">网站管理平台  > <span class="guide-txt">合作伙伴</span></div>
        <!--欢迎及上次登录 开始-->

         <div class="add-main">
          <div class="guide">
            	<ul class="ul-nav02">
                	<li class="hover1">合作伙伴</li>
                    <li  ><a href="PartnersInfo.aspx">添加合作伙伴</a></li>
                    <div class="clear"></div>                                  
                </ul>
            </div>            
            ...
            <div class="cMain-w nb" >
                <div class="cMain-title b-t">
                    <ul class="ul-list"> 
                        ...
                        <li class="Message-Name">合作伙伴名字</li>          
                        <li class="cz">操作</li>
                        <li class="cz">排序</li>
                        <div class="clear"></div>
                    </ul>
