<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkInfo.aspx.cs" Inherits="admin_link_LinkInfo" %>
...
<body>
    ...
    <div id="content">
        ...
        <div class="Main">
            <div class="Showpath">
                网站管理平台 > <span class="guide-txt">友情链接</span></div>
            <!--欢迎及上次登录 开始-->
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li><a href="LinkList.aspx">链接列表</a></li>
                        <li class="hover">添加链接</li>
                        <div class="clear">
                        </div>
                    </ul>
                </div>
