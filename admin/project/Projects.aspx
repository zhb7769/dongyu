<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="admin_project_Projects" %>
...
<div id="content">
    ...
    <div class="Main">
    	<div class="Showpath">网站管理平台  > <span class="guide-txt">案例管理</span></div>


         <div class="add-main">
          <div class="guide">
            	<ul class="ul-nav02">
                	<li class="hover1">案例列表</li>
                    <li  ><a href="PojectInfo.aspx">添加案例</a></li>
                    <div class="clear"></div>                                  
                </ul>
            </div>            
            ...
            <div class="cMain-w nb" >
                ...
                <div class="cMain-con s2" >
                    ...
                    <asp:Repeater ID="rptProject" runat="server" 
                        onitemcommand="rptProject_ItemCommand" >
                      <ItemTemplate>
                        <ul class="ul-list l"> 
                        <li class="sel">
                            <asp:CheckBox ID="cbDel" runat="server" class="check" /></li>
                        <li class="Message-Name"><%#Eval("CN_Title") %> </li>
                        <li class="cz"> <a href="PojectInfo.aspx?L_id=<%#Eval("ID") %>">编辑</a>
