<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClassInfo.aspx.cs" Inherits="admin_product_new_ProductClassInfo" %>
    ...
    <div id="content">
        ...
        <div class="Main">
            ...
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li><a href="ProductClass.aspx">配件分类</a></li>
                            ...
                            <div class="f-l">
                                ...
                                <div class="fieldline">
                                    <div class="c1">
                                        分类排序</div>
                                    <div class="c2">
                                        <asp:TextBox ID="txtSort" runat="server" CssClass="i-a03" onkeypress="return isNumber(event);"></asp:TextBox></div>
                                    <div class="clear">
                                    </div>
                                </div>
                                <div class="fieldline">
