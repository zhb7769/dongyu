<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="admin_product_new_Products" %>
        ...
        <div class="Main">
            ...
            <div class="ss-bor">
                <ul>
                    ...
                    <li class="add"><a href="ProductInfo.aspx">添加配件</a></li>
                    <div class="clear">
                    </div>
                </ul>
            </div>
            ...
            <div class="cMain-w">
                <div class="cMain-title">
                    <ul class="ul-list">
                        ...
                        <li class="title" style="width: 330px;"><span class="underline">配件名称</span></li>
                        <li class="order"><span class="underline">排序</span></li>
                        <li class="subclass"><span class="underline">配件分类</span></li>
