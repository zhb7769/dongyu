<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownloadClass.aspx.cs" Inherits="admin_annex_DownloadClass" %>
...
<body>
    ...
    <div id="content">
        ...
        <div class="Main">
            <div class="Showpath">
                网站管理平台 > <span class="guide-txt">下载中心 > </span><span class="guide-txt">分类管理</span></div>
            <!--欢迎及上次登录 开始-->
            <div class="add-main">
                <div class="guide">
                    <ul class="ul-nav02">
                        <li class="hover1">下载分类</li>
                        <li><a href="DownloadClassInfo.aspx">添加分类</a></li>
                        <div class="clear">
                        </div>
                    </ul>
                </div>
                        ...
                        <asp:Repeater ID="rpt_list" runat="server" OnItemCommand="rpt_list_ItemCommand" OnItemDataBound="rpt_list_ItemDataBound">
                            <ItemTemplate>
                                <ul class="ul-list l">
                                    ...
                                    <li class="cz"><a href='DownloadClassInfo.aspx?C_id=<%#Eval("ID") %>'>编辑</a>
