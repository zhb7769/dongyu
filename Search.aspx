...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="det_pb">
        <div class="all_ban top_news">
            <div class="main_bgc">
                <div class="tit wow bounceInLeft animated">搜索动态</div>
                <div class="all_bantit"><a href="Index.aspx">首页</a><i>></i><span>搜索动态</span></div>
                <div class="search_s">
                    <div class="search_sc clearfix">
                        <asp:TextBox ID="txtKeyword" runat="server" CssClass="search_st"></asp:TextBox>
                        <asp:Button ID="btnSearch" runat="server" CssClass="search_sbtn" Text="搜索" OnClick="btnSearch_Click" />
                    </div>
                </div>
            </div>
        </div>
